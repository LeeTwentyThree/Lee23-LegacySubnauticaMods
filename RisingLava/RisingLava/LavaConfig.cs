...
namespace RisingLava
{
    ...
    public class LavaConfig : ConfigFile
    {
        ...
        [Slider(Label = "Begin challenge automatically", Tooltip = "The base level of the lava, in meters, relative to the default surface of the ocean.\nCan be overriden in-game with the `setlavalevel [level]` command.", DefaultValue = 0, Min = -1700, Max = 50, Step = 10)]
        ...
        public float IntervalChange = 25;
