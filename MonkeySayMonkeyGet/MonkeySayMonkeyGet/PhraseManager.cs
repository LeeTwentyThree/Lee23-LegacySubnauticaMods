...
namespace MonkeySayMonkeyGet
{
    public static class PhraseManager
    {
        ...
        public static void Initialize()
        {
            ...
            AddKnownPhrase("gasopod", "gasifier", "gas upon", "fart", "gas apart", "gossip", "gas pod", "gas up on", "guys pod", "castle pod", "gas");
            ...
            AddKnownPhrase("rabbit ray", "rabbit race", "rabbit right", "robbery", "rabbit raise");
            ...
            AddKnownPhrase("reaper leviathan", "reaper", "leviathan", "river");
        ...
        {   
            ...
            if (everythingIsAnOption && Mod.config.CanMentionEverything)
            {
        ...
        public static TechType GetReferencedTechType(SpeechInput input, out Amount amount)
        {
            ...
            if (Mod.config.CanMentionEverything)
            {
                if (ContainsPhrase(input, Everything))
                {
