namespace MonkeySayMonkeyGet.VoiceCommands
{
    public class SwimSpeed : VoiceCommandBase
    {
        ...
        protected override void Perform(SpeechInput input)
        {
            ...
            swimMotor.acceleration = defaultSwimAcceleration * speedMultiplier;
            ...
            groundMotor.acceleration = defaultWalkAcceleration * speedMultiplier;
        ...
        private float defaultWalkAcceleration = 20f;
