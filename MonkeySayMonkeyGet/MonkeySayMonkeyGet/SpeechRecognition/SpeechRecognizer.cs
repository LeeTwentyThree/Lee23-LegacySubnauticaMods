...
namespace MonkeySayMonkeyGet.SpeechRecognition
{
    public class SpeechRecognizer : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            var path = Path.Combine(Directory.GetParent(Mod.assembly.Location).FullName, Mod.LanguageModelDirPath).Replace('\\', '/'); // just to be safe... i'm afraid the unmanaged assembly dislikes backslashes
            onInitResult(path);
        }
