...
namespace MonkeySayMonkeyGet
{
    public static class Utils
    {
        ...
        public static AudioSource PlaySoundEffect(string clipName, float duration)
        {
            ...
            source.Play();
            source.volume = Mod.config.SoundVolume / 100f;
        ...
        public static List<GameObject> FindObjectsByTechType(TechType techType, int limit, float maxDistance = float.MaxValue)
        {
            ...
            foreach (Transform cell in GetCellsRoot())
            {
        ...
        public static Transform GetCellsRoot()
        {
            return GetLandscapeRoot().Find("Cells");
        }
        ...
        public static void ZaWarudo()
        {
            ...
            {
                stasisSpherePrefab = CraftData.GetPrefabForTechType(TechType.StasisRifle).GetComponent<StasisRifle>().effectSpherePrefab;
            }
            CoroutineHost.StartCoroutine(ZaWarudoCoroutine(VoiceCommands.StarPlatinum.StarPlatinumActivated));
        }
